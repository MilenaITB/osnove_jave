...
public class Zadatak1 {
    public static void main(String[] args) {
        PlaninarskiDom pd = new PlaninarskiDom("Besna kobila",1970);

        RekreativniPlaninar rP1 = new RekreativniPlaninar(1, "Milan Jovanovic",
                20, "Kriva Feja",1650);

        RekreativniPlaninar rp2 = new RekreativniPlaninar(2, "Vladimir Minic",
                10, "Niski",1810);

        Alpinista a1 = new Alpinista(3, "Petar Petrovic",8);
        Alpinista a2 = new Alpinista(4,"Dragan Jovanovic",5);

        Planina p = new Planina("Midzor","Srbija", 2169);
